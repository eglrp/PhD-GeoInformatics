...
gdaladdo --config COMPRESS_OVERVIEW LZW –config BIGTIFF_OVERVIEW=YES -ro -r average x3323da-b_2015_L3a.tif 2 4 8 16 32
...
gdaladdo --config COMPRESS_OVERVIEW LZW –config BIGTIFF_OVERVIEW=YES -ro -r average x3324c_2015_L3a.tif 2 4 8 16 32
