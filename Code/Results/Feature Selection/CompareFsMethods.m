...
%%  Compare the methods
load 'D:\Data\Development\Projects\PhD GeoInformatics\Data\Feature Selection\CompareFsMethodsFCR_AP_Exemplar3.mat'
% cdata = cdata(1)
% close all
clear my*
...
%                      'jmiFormulation', false, 'clusterMethod', 'heirarchical', 'preferredFeatures', preferredFeatures{i});...
             FeatSelClusterRankM([], 'mi', 0, [], 'clusterThresh', innerClusterThresh, 'showFigures', false, ...
                    'jmiFormulation', false, 'clusterMethod', 'heirarchical');...
             FeatSelClusterRankM([], 'mi', 0, [], 'clusterThresh', innerClusterThresh, 'showFigures', false, ...
                    'jmiFormulation', true, 'fsFormulation', false, 'clusterMethod', 'ap', 'apclusterCrit', 'correlation', 'useExemplars', true);...
             FeatSelClusterRankM([], 'mi', 0, [], 'clusterThresh', innerClusterThresh, 'showFigures', false, ...
                    'jmiFormulation', false, 'fsFormulation', false, 'clusterMethod', 'ap', 'apclusterCrit', 'correlation', 'useExemplars', false);...
             FeatSelClusterRankM([], naivebc, 0, [], 'clusterThresh', innerClusterThresh, 'showFigures', false, ...
                    'jmiFormulation', false, 'fsFormulation', false, 'clusterMethod', 'ap', 'apclusterCrit', 'correlation', 'useExemplars', true);...
             FeatSelClusterRankM([], naivebc, 0, [], 'clusterThresh', innerClusterThresh, 'showFigures', false, ...
                    'jmiFormulation', false, 'fsFormulation', false, 'clusterMethod', 'ap', 'apclusterCrit', 'correlation', 'useExemplars', false);...
             FeatSelFeastM([], 'jmi', 0);...
             FeatSelFeastM([], 'mrmr', 0);...
% %              FeatSelFeastM([], 'relief', 0);...
...
methodNames = {'FCR-H-mi', 'FCR-H-naivebc-nopref', 'FCR-ap-naivebc', 'FCR-ap-naivebc25', 'FCR-ap-naivebc25-nopref'};
methodNames = {'featseli-naivebc', 'featself-naivebc', 'featseli-mi', 'featself-mi', 'featself-naivebc30'};

methodNames = {'FCR-H-naivebc', 'FCR-H-mi', 'FCR-ap-naivebc', 'FCR-ap-naivebc25', 'FCR-ap-naivebc25-nopref'};
methodNames = {'FCR-H-mi', 'FCR-ap-naivebc25-nopref', 'FCR-ap-mi', 'FCR-ap-mi-nopref'};
methodNames = {'FCR-H-mi', 'FCR-ap-mi-nopref'}; %, 'FCR-ap-mi-jmi-nopref'};
methodNames = {'FCR-H-mi', 'FCR-ap-distcorr-nopref'}; %, 'FCR-ap-mi-jmi-nopref'};
methodNames = {'FCR-ap-nopref', 'FCR-ap-nopref-jmiFormulation2', 'JMI'}; %, 'FCR-ap-mi-jmi-nopref'};
methodNames = {'FCR-ap-naivebc-nopref', 'FCR-ap-naivebc-nopref-jmiFormulation2'}; %, 'FCR-ap-mi-jmi-nopref'};
methodNames = {'FCR-H-mi', 'FCR-ap-mi-nopref', 'featself-naivebc', 'featself-mi', 'featseli-naivebc', 'featseli-mi'}; %, 'FCR-ap-mi-jmi-nopref'};
methodNames = {'FCR-H-mi-nopref', 'FCR-ap-mi-nopref', 'FCR-ap-distcorr-nopref'}; %, 'FCR-ap-mi-jmi-nopref'};
methodNames = {'FCR-H-mi-nopref', 'FCR-ap-mi-nopref', 'FCR-ap-naivebc-nopref', 'featself-naivebc', 'featself-mi', 'featseli-naivebc', 'featseli-mi'}; %, 'FCR-ap-mi-jmi-nopref'};

methodNames = {'FCR-ap-naivebc25-nopref', 'FCR-ap-naivebc25-nopref-fsform'}; %, 'FCR-ap-mi-jmi-nopref'};
methodNames = {'FCR-H-mi', 'FCR-ap-mi', 'FCR-ap-mi-noex'}; %, 'FCR-ap-mi-jmi-nopref'};
methodNames = {'FCR-H-mi-nopref', 'FCR-ap-mi-nopref', 'FCR-ap-mi-nopref-noex', 'FCR-ap-naivebc-nopref', 'FCR-ap-naivebc-nopref-noex', ...
    'JMI', 'MRMR', 'featself-mi', 'featself-naivebc', 'featseli-mi', 'featseli-naivebc', 'featselb-mi', 'featselb-naivebc'}; %, 'FCR-ap-mi-jmi-nopref'};
...
save 'D:\Data\Development\Projects\PhD GeoInformatics\Data\Feature Selection\CompareFsMethodsFCR_AP_FsFormulation.mat'
save 'D:\Data\Development\Projects\PhD GeoInformatics\Data\Feature Selection\CompareFsMethodsFCR_AP_Exemplar.mat'
save 'D:\Data\Development\Projects\PhD GeoInformatics\Data\Feature Selection\CompareFsMethodsFCR_AP_Exemplar2.mat'
save 'D:\Data\Development\Projects\PhD GeoInformatics\Data\Feature Selection\CompareFsMethodsFCR_AP_Exemplar3.mat'
