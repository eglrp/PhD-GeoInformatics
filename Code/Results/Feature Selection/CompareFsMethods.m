...
methodNames = {'FCR-H-mi-nopref', 'FCR-ap-mi-nopref', 'FCR-ap-mi-nopref-noex', 'FCR-ap-naivebc-nopref', 'FCR-ap-naivebc-nopref-noex', ...
    'JMI', 'MRMR', 'featself-mi', 'featself-naivebc', 'featseli-mi', 'featseli-naivebc'}; %, 'FCR-ap-mi-jmi-nopref'};
...
%     methodNamesAbbr = {'FCR-H-MI', 'FCR-AP-MI', 'FCR-AP-NaiveBC', 'FS-NaiveBC', 'FS-MI', 'Rank-NaiveBC', 'Rank-MI'};
    ...
    'JMI', 'MRMR', 'FS-MI', 'FS-NaiveBC', 'Rank-MI', 'Rank-NaiveBC'}; %, 'FCR-ap-mi-jmi-nopref'};
...
fontsize(9)
print('C:\Data\Development\Projects\PhD GeoInformatics\Docs\My Docs\Thesis\Feature Clustering and Ranking\Figure 2 - Method stability per data set (tmp).eps', ...
    '-depsc', '-r1200')
