...
%              FeatSelClusterRankM([], 'mi', 0, [], 'clusterThresh', innerClusterThresh, 'showFigures', false, ...
%                     'jmiFormulation', false, 'fsFormulation', false, 'clusterMethod', 'ap', 'apclusterCrit', 'correlation');...
%              FeatSelClusterRankM([], naivebc, 0, [], 'clusterThresh', innerClusterThresh, 'showFigures', false, ...
%                     'jmiFormulation', false, 'fsFormulation', false, 'clusterMethod', 'ap', 'apclusterCrit', 'correlation');...
              FeatSelFeastM([], 'jmi', 0);...
%              FeatSelFeastM([], 'mrmr', 0);...
%              FeatSelFeastM([], 'relief', 0);...
                 featself([], naivebc([], 25), innerNumFeatures, 5);...
%                  featself([], 'mi', innerNumFeatures);...
%                  featseli([], naivebc([], 25), innerNumFeatures, 5);...
