...
for orthoFileName in glob.glob(os.path.join(orthoDir, 'o*RGB.tif')):
    ...
    print 'Fixing overviews for {0}'.format(os.path.join(orthoDir, baseFileName))
    cmdString = '"{0}" -r average "{1}" 128 256'.format(gdaladdoExe,
        os.path.join(orthoDir, baseFileName))
