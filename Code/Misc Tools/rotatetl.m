...
c1=(c(1,tb)+(c(1,2)-c(1,1))*l).*ones(1,length(b1)); % upper ticks
c2=(c(1,tb)+(c(1,2)-c(1,1))*l).*ones(1,length(b1)); % lower ticks

tl1=text(b1,c1,a1,'HorizontalAlignment','right','rotation',rot,'VerticalAlignment','middle');
tl2=text(b2,c2,a2,'HorizontalAlignment','right','rotation',rot,'VerticalAlignment','middle');
